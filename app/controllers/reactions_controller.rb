class ReactionsController < ApplicationController
  ...
  private
    ...
    def reaction_params
      params.require(:reaction).permit(:authority, :publication, :delivery_mechanism, :infection_type, :isolate_id, :drug_id, :reaction, :footnote, :eligible_interpretations, :rule_row_number, :used_surrogate_drug_id, :used_surrogate_drug_ordinal, :used_surrogate_rule_type)
    end
end
